...
var VSHADER_SOURCE = 
  ...
  '	 gl_Position.x += u_shiver.x * sin(10.0 * gl_Position.y + u_shiver.y+u_offset);\n' +
  '	 gl_Position.y += u_shiver.x * sin(10.0 * gl_Position.y + u_shiver.y+u_offset);\n' +
  '  gl_PointSize = 10.0;\n' +
  '  v_Color = a_Color;\n' +
  '}\n';
...
//=====================================================================
  ...
  gl.uniform2f(u_shiver, 0.03, 0.0);
  var offset = 0;
  var u_offset = gl.getUniformLocation(gl.program, 'u_offset');
