...
//------------Add more shapes:
 this.appendGroundGrid();	// Append all vertices needed to draw ground-plane grid
						// (see fcn below; it updates vboVerts too!)
/*
 ...
 ///etc...
*/ 
	// set parameters for vertex storage & transfer:
