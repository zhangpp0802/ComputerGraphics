...
//=============================================================================
//==============================================================================
function PartSys(x,y,z,vx,vy,vz) {
//==============================================================================
//=============================================================================
...
// That's OK for most particle parameters, but these need non-zero defaults:
  ...
  for(var i = 0; i < this.partCount; i += 1, j+= PART_MAXVAR) {
    ...
    this.s1[j + PART_XPOS] = this.x; 
    this.s1[j + PART_YPOS] = this.y;  
    this.s1[j + PART_ZPOS] = this.z;
    this.s1[j + PART_WPOS] =  1.0; 
    // this.s2[j + PART_XPOS] = 3.0; 
    // this.s2[j + PART_YPOS] = 0.0;  
    // this.s2[j + PART_ZPOS] = 1.0;
    ...
    this.s1[j + PART_XVEL] =  this.vx;
    this.s1[j + PART_YVEL] =  this.vy;
    this.s1[j + PART_ZVEL] =  this.vz;
    ...
    // this.s2[j + PART_LIFELEFT] = 10 + 10*Math.random();// 10 to 20
